...
<div style="display: flex; justify-content: center; align-items: center; gap: 20px;">
   <iframe src="/ada-outlier-datastory/assets/img/links_categories.html" 
      ...
      style="max-width: 40%; height: auto;" ></iframe>
</div>
<!-- INITIAL TEXT:
...
<div style="display: flex; justify-content: center; align-items: center; gap: 20px;">
   ...
   <iframe src="/ada-outlier-datastory/assets/img/categories_unfinished_paths_start2target_datastory.html" class="responsive-iframe" style="max-width: 40%; height: auto;" alt='categories_unfinished_paths_start2target'></iframe>
</div>
...
<div style="display: flex; justify-content: center; align-items: center; gap: 20px;">
   <iframe src="/ada-outlier-datastory/assets/img/distrib_path_lengths_wrt_shortest_path.html" class="responsive-iframe" style="max-width: 40%; height: auto;" alt='distrib_path_lengths_wrt_shortest_path'></iframe>
</div>
...
<div style="display: flex; justify-content: center; align-items: center; gap: 20px;">
   <iframe src="/ada-outlier-datastory/assets/img/distrib_links_to_target" style="max-width: 40%; height: auto;" alt='distrib_links_to_target'
...
<div style="display: flex; justify-content: center; align-items: center; gap: 20px;">
   ...
   class="responsive-iframe" style="max-width: 40%; height: auto;" alt='results_log_reg'></iframe>
</div>
